...
public:
    ...
    DrawPath(ColoredDrawTool const& tool, QPointF const* const points, int const number, quint16 const size, quint16 const eraser_size = 10);
    ...
    /// Clear all points and reset hash and boundary rectangle.
    void clear();
    ...
    /// Rectangle containing this path.
