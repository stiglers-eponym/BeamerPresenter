...
const char *action_to_description(const Action action) noexcept
{
    ...
    case NextSkippingOverlays:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
                "go to next page which has not the same page label as the current page");
    case PreviousSkippingOverlays:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
    ...
    case UndoDrawing:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
                "undo last drawing/erasing step in the presentation on the current slide");
    ...
    case LoadDrawingsNoClear:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
                "load drawings etc. from file without first clearing existing drawings");
    // Modify drawn items
    case CopyClipboard:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
    ...
    case FullScreen:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
                "toggle fullscreen mode for currently active window");
    case Quit:
        return QT_TRANSLATE_NOOP(
                "ActionButton",
