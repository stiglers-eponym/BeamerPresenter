...
Timer::~Timer()
{
    disconnect(timerEdit, &QLineEdit::returnPressed, this, &Timer::setDeadline);
    disconnect(timerEdit, &QLineEdit::returnPressed, this, &Timer::sendEscape);
    disconnect(timer, &QTimer::timeout, this, &Timer::showTime);
    delete deadline;
    delete time;
    delete timer;
}
