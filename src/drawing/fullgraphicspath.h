...
class FullGraphicsPath : public AbstractGraphicsPath
{
 ...
 public:
  ...
  FullGraphicsPath(const DrawTool &tool, const QPointF &pos,
  ...
  FullGraphicsPath(const DrawTool &tool, const QString &coordinate_string,
  ...
  FullGraphicsPath(const DrawTool &tool, const QVector<QPointF> &coordinates,
