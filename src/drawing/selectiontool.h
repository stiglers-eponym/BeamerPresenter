...
class SelectionTool : public Tool
{
 ...
 public:
  ...
  SelectionTool(const SelectionTool &other) noexcept
      : Tool(static_cast<const Tool &>(other)), properties(other.properties)
  {
  }
  ...
  const void *scene() const noexcept { return _scene; }
