 ...
 public:
  ...
  virtual bool operator==(const DrawTool &other) const noexcept
  {
    return _tool == other._tool && _device == other._device &&
           _pen == other._pen && _brush == other._brush &&
           composition_mode == other.composition_mode && _shape == other._shape;
  }
  ...
  /// @return _pen
  QPen &rpen() noexcept { return _pen; }

  /// @return _pen
  const QPen &pen() const noexcept { return _pen; }

  /// @return stroke width in points
  float width() const noexcept { return _pen.widthF(); }

  /// @return pen color
  QColor color() const noexcept override { return _pen.color(); }

  /// Set stroke color.
  void setColor(const QColor &color) noexcept override { _pen.setColor(color); }

  /// @return _brush
  const QBrush &brush() const noexcept { return _brush; }

  /// @return _brush
  QBrush &brush() noexcept { return _brush; }

  /// @return _shape
  Shape shape() const noexcept { return _shape; }

  void setShape(Shape shape) noexcept { _shape = shape; }
  ...
  /// Overwrite pen.
  void setPen(const QPen &pen) noexcept { _pen = pen; }
