...
class TextTool : public Tool
{
 ...
 public:
  ...
  TextTool(const TextTool &other)
      : Tool(TextInputTool, other._device),
        _font(other._font),
        _color(other._color)
  {
  }
  ...
  /// @return _font
  QFont &font() noexcept { return _font; }

  /// @return _font
  const QFont &font() const noexcept { return _font; }

  /// @return _color
  QColor color() const noexcept override { return _color; }

  /// set function for _color
  void setColor(const QColor &color) noexcept override { _color = color; }

  /// set function for _font
  void setFont(const QFont &font) noexcept { _font = font; }
};
